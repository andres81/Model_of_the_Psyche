...
[R.I.C.E.](https://www.youtube.com/watch?v=7XmgkWCtnhE)
...
We need to mature, and choose to step into this universe as adults, choosing to
carry society. Not depend on what society will tell us what is acceptable and
what not.
...
explicit design of society, and thén, and only then comes the form, the formal
architecture. Then you are acting mature: not shying away from responsibility,
not going to short term rewards, acting on impuls, but acting on ideals, a goal,
set together:
...
Instead of the term "evil": Thermodynamically unfavorable phenomena.
    ...
    Evil in the sense of evil within this universe. "Evil" as meant by the
    Catholic Church... different beast!

Is evil a concept in itself, which it is, but is it one in reality or merely
a construct of the mind, to cope with the realisation of a lack of control over
what happens around us? Every process is thermodynamic in nature:
[Entropy is increasing over time in any system.](https://en.wikipedia.org/wiki/Entropy_as_an_arrow_of_time)

Is bullying evil, or the result of thermodynamic processes, that cause a faster
increase in entropy then necessary for the benefit of the systems (humans) that
are causing the undesired behavior (bullying). Gaining energy by a system goes
at the cost of the entropy of other systems.

In other words: At the end, can we maybe conclude that the set of emotions
organisms are subject to are a descriptive tool to describe the thermodynamics
surrounding us, inside us, and an indication of possible outcomes of engagements
with the outside world and the potential thermodynamic outcomes of said
engagements? Including the thermodynamic situation of the system the subject is
...
emergence, that should be dismantled, gently, for it can have side effects that
can harm other systems.
