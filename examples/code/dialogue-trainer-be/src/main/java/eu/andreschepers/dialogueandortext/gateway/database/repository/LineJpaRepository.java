...
public interface LineJpaRepository extends JpaRepository<LineJpaEntity, UUID> {

    boolean existsLineJpaEntityByLineShaSum(String shaSum);
    Optional<LineJpaEntity> findByLineShaSum(String shaSum);
}
