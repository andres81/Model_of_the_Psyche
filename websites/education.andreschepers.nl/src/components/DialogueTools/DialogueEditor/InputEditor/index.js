        ...
        return (
            <div className="dialogue-editor-edit-section">
                <div className="row dialogue-editor-edit-section-audio-input">
                    <div>
                        <input key={uuidv4()} value={this.props.youtubeEmbedId} onChange={(e) => this.props.onYoutubeEmbedId(e.target.value)} type={"text"} placeholder="Youtube Embed Id" />
                    </div>
                    <div className="audio-source-file-open-container">
                        ...
                        <textarea rows={1} value={this.props.audioSource} onChange={(e) => this.props.onAudioChange(e.target.value)} type={"text"} placeholder="Dialogue audio (ogg)" />
                    </div>
                </div>
                {this.createRows()}
            </div>
