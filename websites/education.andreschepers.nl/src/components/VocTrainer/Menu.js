...
import {StateUpdateType} from './engine'
    ...
    render() {
        ...
        return (
            <div className="menu-container">
                ...
                {this.createNbspElement()}
                {this.props.isRotationLocked ?
                     this.createButton(() => this.props.lockOptionRotation(false), false, <RiRotateLockFill />, "Lock option rotation")
                     :
                     this.createButton(() => this.props.lockOptionRotation(true), false, <FiRotateCw />, "Lock option rotation")
                }
                {this.createNbspElement()}
                {this.createButton(() => this.props.toggleShowAnswer(), this.props.showAnswer, <IoIosInformationCircleOutline />, "Toggle answer")}
                {this.createNbspElement()}
                <div className="btn-group btn-group-sm" role="group">
