                ...
                <div className="container">
                    ...
                    <div className="row text-center">
                        <div className="col-md-4">
                            ...
                            <p className="text-muted">How does the psyche work? What is the architecture? What are the basic principles? I have new insights!</p>
                        ...
                        <div className="col-md-4">
                            ...
                            <p className="text-muted">Can we learn a new language in two weeks? Can we learn non-stop (sub)-consciously? Part of the Model of the Psyche project</p>
                        </div>
                        <div className="col-md-4">
                            <h4 className="my-3">Rules of Engagement</h4>
                            <p className="text-muted">A large project that focusses on the basic rules of interaction between objects. This also means focus on the social interaction of humans.</p>
                        </div>
                    </div>
                </div>
                <br /><br /><br />
