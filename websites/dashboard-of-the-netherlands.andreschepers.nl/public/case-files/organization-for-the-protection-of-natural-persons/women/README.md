...
but also the work that can be done during going through the pipeline?
...
* Cognitive data buffers: Overwriting implicit attitudes, making explicit 
  ones / being aware of implicit ones and the resulting behaviors they cause.
  Being more resilient to the attempts of manipulation, and cognitive 
  reprogramming. ("Games people play" is part of this intervention)
* Shadow work
...
The idea is to translate the list of books below into elements of the
training pipeline envisioned above.
