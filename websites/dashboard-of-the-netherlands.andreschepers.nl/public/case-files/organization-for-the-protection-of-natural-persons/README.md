# Organization for the Protection of Natural Persons
...
number of accidents. As wikipedia states:

```
Contrary to what many think, the VCA is not a means of demonstrating
compliance with the Working Conditions Act.
It is only an instrument to better meet the requirements of the client.
```
